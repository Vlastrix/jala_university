...
def play():
    ...
    print("Remember that you can only attack and defend twice in the game!")
    ...
    while playing:
        ...
        player_action = input("Do you want to defend or attack: ").lower()

        if player_action == "attack":
            if current_robot.attack_count == 2:
                playing = False
